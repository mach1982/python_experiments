...
def irl():
    ...
    tweets = api.get_tweets(query = '#IRL', count =500)
    ...
    print("Negative tweets Ireland: {} %".format(round(100*len(ntweets)/len(tweets))))
    # percentage of neutral tweets
def uk():
    # creating object of TwitterClient Class    print("1")
    api = TwitterClient()
    # calling function to get tweets
    tweets = api.get_tweets(query = '#GBR', count =500)
    ...
    ntweets = [tweet for tweet in tweets if tweet['sentiment'] == 'negative']
    # percentage of negative tweets
    print("Negative tweets UK: {} %".format(round(100*len(ntweets)/len(tweets))))
    # percentage of neutral tweets
def fra():
    # creating object of TwitterClient Class    print("1")
    api = TwitterClient()
    # calling function to get tweets
    tweets = api.get_tweets(query = '#FRA', count =500)
    ...
    ntweets = [tweet for tweet in tweets if tweet['sentiment'] == 'negative']
    # percentage of negative tweets
    print("Negative tweets France: {} %".format(round(100*len(ntweets)/len(tweets))))
    # percentage of neutral tweets
